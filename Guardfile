...
guard 'livereload' do
  watch(%r{^{{cookiecutter.app_name}}/{{cookiecutter.app_name}}/static/css/.+\.css$})
  watch(%r{^{{cookiecutter.app_name}}/{{cookiecutter.app_name}}/static/js/.+\.js$})
  watch(%r{^{{cookiecutter.app_name}}/{{cookiecutter.app_name}}/.+\.py$})
  watch(%r{^{{cookiecutter.app_name}}/{{cookiecutter.app_name}}/.+\.html$})
end
